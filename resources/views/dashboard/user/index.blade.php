                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="project-actions text-right">
                                <a class="btn btn-primary btn-sm" href="/dashboard/users/{{ $user->username }}/edit-password">
                                    <i class="fas fa-key"></i>
                                    Pass
                                </a>
                                <a class="btn btn-info btn-sm" href="/dashboard/users/{{ $user->username }}/edit">
                                ...
                                <form action="/dashboard/users/{{ $user->username }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="btn btn-danger btn-sm" data-title="{{ $user->nama }}">
