...
<div class="row">
    <div class="col-md-6">
        <div class="card card-primary">
            ...
            <form action="/dashboard/usulans" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="kode_rekening_id" id="kode_rekening" class="form-control select2bs4 @error('kode_rekening_id') is-invalid @enderror" style="width: 100%;">
                            ...
                            <option value="{{ $kode_rekening->id }}" @selected(old('kode_rekening_id') == $kode_rekening->id)>
                                {{ $kode_rekening->kode }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input name="keterangan" type="text" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" value="{{ old('keterangan') }}" placeholder="Masukan keterangan...">
                        @error('keterangan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
